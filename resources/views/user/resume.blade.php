    ...
    <section class="user-dashboard">
      ...
      <div class="chosen-drop">
        ...
        <ul class="chosen-results"></ul>
                            ...
                            <div class="form-group col-lg-6 col-md-12">
                              <label>Skills </label>
                              <select data-placeholder="Categories" class="chosen-select multiple" multiple="" tabindex="-1" style="display: none;">
                                ...
                                <input class="chosen-search-input default" type="text" autocomplete="off" value="Categories" tabindex="4" style="width: 97.55px;">
                                </li>
                            </ul>
                                <div class="chosen-drop">
                                <ul class="chosen-results"></ul>
