        ...
        <div class="row align-items-start justify-content-between">
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                <div class="card-wrap-body mb-4 gray rounded p-3">
                    <h4 class="ft-medium mb-3 theme-cl">Our Office</h4>
                    <p>EUROPE: International House 24 Holborn Viaduct London, EC1A 2BN, United Kingdom</p>
                    <p> AFRICA: 1, Adeola Adeoye Street, Off Toyin Street, Ikeja, Lagos Nigeria </p>
                    <p class="lh-1"><span class="text-dark ft-medium">Email:</span> cv@portrec.co.uk | enquiries@portrec.co.uk </p>
                </div>
                ...
                <div class="card-wrap-body mb-3 gray rounded p-3">
                    ...
                    <p class="mb-2">UK: +44 746 658 8324</p>
                    <p class="mb-2">NG: +23417001770</p>
                    <p class="mb-2">NG: +2349153414314</p>
                </div>
                
                <div class="card-wrap-body mb-3 gray rounded p-3">
                    <h4 class="ft-medium mb-3 theme-cl">Drop A Mail</h4>
                    <p>Fill out our form and we will contact you within 24 hours.</p>
                    <p class="lh-1 text-dark">cv@portrec.co.uk</p>
                    <p class="lh-1 text-dark">enquiries@portrec.co.uk</p>
                </div>
            </div>
